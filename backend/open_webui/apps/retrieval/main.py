...
app.state.config.ENABLE_RAG_CONTEXTLESS_CONTINUATION = ENABLE_RAG_CONTEXTLESS_CONTINUATION
...
async def get_query_settings(user=Depends(get_admin_user)):
    return {
        ...
        "contextlessContinuation": app.state.config.ENABLE_RAG_CONTEXTLESS_CONTINUATION,
    }
...
class QuerySettingsForm(BaseModel):
    ...
    contextlessContinuation: Optional[bool] = None
...
async def update_query_settings(
    ...
    app.state.config.ENABLE_RAG_CONTEXTLESS_CONTINUATION = form_data.contextlessContinuation if form_data.contextlessContinuation else False
